...
namespace XSecure.Services.Users.Infrastructure.Handlers
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Action<XSecureException> _onCustomError;
        private Action<XSecureException, ILogger> _onCustomErrorWithLogger;
        private Func<Exception, Task> _onErrorAsync;
        private Func<Exception, ILogger, Task> _onErrorWithLoggerAsync;
        private Func<XSecureException, Task> _onCustomErrorAsync;
        private Func<XSecureException, ILogger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Action<XSecureException> onCustomError, 
        ...
        public IHandlerTask OnCustomError(Action<XSecureException, ILogger> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        public IHandlerTask OnCustomError(Func<XSecureException, Task> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        public IHandlerTask OnCustomError(Func<XSecureException, ILogger, Task> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        public void Execute()
        {
            ...
            {
                var customException = exception as XSecureException;
