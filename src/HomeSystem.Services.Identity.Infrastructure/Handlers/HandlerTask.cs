...
namespace HomeSystem.Services.Identity.Infrastructure.Handlers
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Action<HomeSystemException> _onCustomError;
        private Action<HomeSystemException, ILogger> _onCustomErrorWithLogger;
        private Func<Exception, Task> _onErrorAsync;
        private Func<Exception, ILogger, Task> _onErrorWithLoggerAsync;
        private Func<HomeSystemException, Task> _onCustomErrorAsync;
        private Func<HomeSystemException, ILogger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Action<HomeSystemException> onCustomError, 
        ...
        public IHandlerTask OnCustomError(Action<HomeSystemException, ILogger> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        public IHandlerTask OnCustomError(Func<HomeSystemException, Task> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        public IHandlerTask OnCustomError(Func<HomeSystemException, ILogger, Task> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        public void Execute()
        {
            ...
            {
                var customException = exception as HomeSystemException;
