...
{
    public class EnableTwoFactorAuthenticationRejectedIntegrationEvent : IIntegrationRejectedEvent
    {
        ...
        [JsonConstructor]
        public EnableTwoFactorAuthenticationRejectedIntegrationEvent(Guid requestId, 
