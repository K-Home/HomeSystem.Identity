...
{
    public class TwoFactorAuthenticationDisabledIntegrationEvent : IIntegrationEvent
    {
        ...
        [JsonConstructor]
        public TwoFactorAuthenticationDisabledIntegrationEvent(Guid requestId, Guid userId, string message)
        {
            RequestId = requestId;
            UserId = userId;
            Message = message;
